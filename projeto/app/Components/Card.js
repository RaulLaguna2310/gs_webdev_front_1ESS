export default function Card() {
  return (
    <>
      <div
        className="flex justify-start items-center gap-4 h-auto w-6xl p-4 mb-5 rounded-xl shadow-lg bg-white transition-transform duration-500 ease-out 
        hover:scale-102"
      >
        <img
        ...
        <div className="flex flex-col">
          <span className="text-lg font-semibold  dark:text-black">Nome</span>
